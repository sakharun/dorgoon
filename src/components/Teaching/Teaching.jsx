...
export default function Teaching() {
  ...
  return (
    <section>
      ...
      <ul>
        <li>
          <h3 className="centered">Өй туруктарын оҥкула</h3>
          <img src={Soznanie} alt="img" width={100} />
          <p>
            Орто туруга. Орто турууга баар Аан Дойдуну көрдөрөр ойуу. Күннээҕи
            олоххо Өйдөөн-төйдөөн туттуу бэлиэтэ (Сознание).{" "}
          </p>
          <img src={under} alt="img" width={100} />
          <p>
            Алын туруга. Аллараа Дойдуну көрдөрөр ойуу. Өбүгэ Өйө уонна Бэйэҥ
            билэн иҥэриммит Өй бэлиэтэ (ПодСознание).{" "}
          </p>
          <img src={over} alt="img" width={100} />
          <p>
            Үөһээ туруга. Үөһээ Дойдуну көрдөрөр ойуу. Бу турукка тахсар Аан
          ...
          <p>
            Бу куйаар бэлиэтэ. Орто турууга баар Аан Дойду олохтооҕо тахсыбат.
